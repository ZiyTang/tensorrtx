#ifndef _SEGMENT_LAYER_H
#define _SEGMENT_LAYER_H
...
namespace Seg
{
    ...
    struct alignas(float) DetectionWithSeg {
...
namespace nvinfer1
{
    ...
    class API SegmentPluginCreator : public IPluginCreator
    {
    public:
        SegmentPluginCreator();

        ~SegmentPluginCreator() override = default;
    ...
    REGISTER_TENSORRT_PLUGIN(SegmentPluginCreator);
};

#endif  // _SEGMENT_LAYER_H
